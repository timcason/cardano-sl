...
instance ( Typeable b
    ...
    decode = do
        ...
        eitherToFail $ T.recreateGenericHeader _gbhPrevBlock _gbhBodyProof _gbhConsensus _gbhExtra
...
instance ( Typeable b
    ...
    decode = do
        ...
        eitherToFail $ T.recreateGenericBlock _gbHeader _gbBody _gbExtra
